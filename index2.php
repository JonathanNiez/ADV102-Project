                    ...
                    <div class="search-logo">
                            ...
                            <div class="modal-dialog" role="document">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-info btn-lg" name="search">Search</button>
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active">
                      <div class="carousel-game-image">
                        <img src="images/battlefield-2042-1.jpg" class="img-fluid" alt="...">
                      </div>
                  </div>
                  <div class="carousel-item">
                    <div class="carousel-game-image">
                        <img src="images/call-of-duty-vanguard-01.jpg" class="img-fluid" alt="...">
                    </div>
                  </div>
                  <div class="carousel-item">
                    <div class="carousel-game-image">
                        <img src="images/forzahorizon5.png" class="img-fluid" alt="...">
                    </div>
                  </div>
                  <div class="carousel-item">
                    <div class="carousel-game-image">
                        <img src="images/farcry6.png" class="img-fluid" alt="...">
                    </div>
                  </div>
                  <div class="carousel-item">
                    <div class="carousel-game-image">
                        <img src="images/bioshock.png" class="img-fluid" alt="...">
                    </div>
                  </div>
                  <div class="carousel-item">
                    <div class="carousel-game-image">
                        <img src="images/hitman3.png" class="img-fluid" alt="...">
                    </div>
                  </div>
                  <div class="carousel-item">
                    <div class="carousel-game-image">
            ...
            <?php while ($rows=mysqli_fetch_assoc($result)){?>
                <div class="col">
                    ...
                    <div class="games-card-overlay">
                        ...
                        <button class="btn btn-danger btn-lg buynow" name="buynow" type="submit">Buy Now</button>
                        </form>
                        <?php 
                        ...
                        <input type="hidden" name="id" value="<?php echo $rows['ProductID']; ?>">
                        <button class="btn btn-warning btn-lg addtocart" name="addtocart" type="submit">Add to Cart</button>
                        </form>
                        <?php 
                        }
                        ?>
