          ...
          <div class="row">
              <div class="col">
                <div class="wrapper">
                    ...
                    <input type="text" name="game-name" class="form-control" value="<?php echo $rows['ProductName'];  ?>" required placeholder="Game Name">
                    </div>
                    <div class="form-group">
                    <input type="text" name="game-price" class="form-control" value="<?php echo $rows['Price'];  ?>" required placeholder="Price">
                    </div>
                    <div class="form-group">
                    <input type="text" name="quantity" class="form-control" value="<?php echo $rows['Quantity'];  ?>" required placeholder="Quantity">
                    </div>
                    <div class="form-group">
                    ...
                    <button type="submit" name="update" class="btn btn-warning btn-lg mx-auto d-block">Update</button>
                    <a href="adminviewproducts.php" class="btn btn-danger btn-lg mx-auto d-block">Cancel</a>
                    </form>
                    </div>
              </div>
          </div>
